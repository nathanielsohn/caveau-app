...
import { LockerCheckOutBodySchema, parseOr400 } from "@/lib/schemas";
import { checkOutWine } from "@/lib/locker-scan";
...
export async function POST(request: NextRequest) {
  ...
  const parsed = parseOr400(LockerCheckOutBodySchema, body);
