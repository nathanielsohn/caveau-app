...
// this route in src/middleware.ts. The certificate URL is auth-gated,
// but the integrity hash on the page can still leak via outbound
// Referer when a user clicks a link off-site — this keeps it contained.
