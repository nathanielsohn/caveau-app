...
- Available tools: getMemberPortfolio, getLivexPriceHistory, getActiveAlerts, getCCRList, getTierDetails, getWineDetail, getLivexBenchmark, getPortfolioVsLivex, getExitSignals, getInsuranceSavingsEstimate, getMyAllocations. All are read-only; you cannot mutate state.
