...
- Available tools: getMemberPortfolio, getLivexPriceHistory, getActiveAlerts, getCCRList, getTierDetails, getWineDetail, getLivexBenchmark, getExitSignals, getInsuranceSavingsEstimate. All are read-only; you cannot mutate state.
